...
globalThis.onMidiMessageInternal = function(data) {
    ...
    if (view === VIEWS.OVERTAKE_MODULE && overtakeModuleLoaded && overtakeModuleCallbacks && !overtakeInitPending) {
        ...
        if (coRunUiActive() && (status & 0xF0) === 0xB0) {
            ...
            /* Menu (CC 50): open FX bus picker during co-run (#117). */
            if (d1 === 50 && d2 > 0) {
                coRunView = VIEWS.FX_BUS_PICKER;
             ...
             * track press can't flip it into chain-edit co-run. (coRunWants +
             * overlay guard from #112, kept over #117's older coRunCedes.) */
